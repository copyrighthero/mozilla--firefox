...
const result = UniFFIScaffolding.callSync(
    33, // uniffi_logins_fn_func_check_canary
...
FfiConverterString.checkType(encryptionKey);
const result = UniFFIScaffolding.callSync(
    34, // uniffi_logins_fn_func_create_canary
    FfiConverterString.lower(text),
    FfiConverterString.lower(encryptionKey),
)
return handleRustResult(
...
const result = UniFFIScaffolding.callSync(
    35, // uniffi_logins_fn_func_create_key
)
return handleRustResult(
    result,
    FfiConverterString.lift.bind(FfiConverterString),
...
const result = UniFFIScaffolding.callSync(
    36, // uniffi_logins_fn_func_create_login_store_with_nss_keymanager
...
const result = UniFFIScaffolding.callSync(
    37, // uniffi_logins_fn_func_create_login_store_with_static_key_manager
    FfiConverterString.lower(path),
...
const result = UniFFIScaffolding.callSync(
    38, // uniffi_logins_fn_func_create_managed_encdec
...
FfiConverterString.checkType(key);
const result = UniFFIScaffolding.callSync(
    39, // uniffi_logins_fn_func_create_static_key_manager
    FfiConverterString.lower(key),
)
return handleRustResult(
    result,
...
export class EncryptorDecryptorImpl extends EncryptorDecryptor {
    ...
    decrypt(
        ...
        const result = UniFFIScaffolding.callSync(
            40, // uniffi_logins_fn_method_encryptordecryptor_decrypt
    ...
    encrypt(
        ...
        const result = UniFFIScaffolding.callSync(
            41, // uniffi_logins_fn_method_encryptordecryptor_encrypt
            FfiConverterTypeEncryptorDecryptor.lowerReceiver(this),
...
export class KeyManagerImpl extends KeyManager {
    ...
    getKey() {
        ...
        const result = UniFFIScaffolding.callSync(
            42, // uniffi_logins_fn_method_keymanager_get_key
...
export class LoginStore extends LoginStoreInterface {
    ...
    static async init(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            43, // uniffi_logins_fn_constructor_loginstore_new
            FfiConverterString.lower(path),
    ...
    async add(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            44, // uniffi_logins_fn_method_loginstore_add
    ...
    async addMany(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            45, // uniffi_logins_fn_method_loginstore_add_many
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async addManyWithMeta(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            46, // uniffi_logins_fn_method_loginstore_add_many_with_meta
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async addOrUpdate(
        ...
        FfiConverterTypeLoginEntry.checkType(login);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            47, // uniffi_logins_fn_method_loginstore_add_or_update
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterTypeLoginEntry.lower(login),
        )
        return handleRustResult(
    ...
    async addWithMeta(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            48, // uniffi_logins_fn_method_loginstore_add_with_meta
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async arePotentiallyVulnerablePasswords(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            49, // uniffi_logins_fn_method_loginstore_are_potentially_vulnerable_passwords
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async count() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            50, // uniffi_logins_fn_method_loginstore_count
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async countByFormActionOrigin(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            51, // uniffi_logins_fn_method_loginstore_count_by_form_action_origin
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async countByOrigin(
        ...
        FfiConverterString.checkType(origin);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            52, // uniffi_logins_fn_method_loginstore_count_by_origin
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async delete(
        ...
        FfiConverterString.checkType(id);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            53, // uniffi_logins_fn_method_loginstore_delete
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async deleteMany(
        ...
        FfiConverterSequenceString.checkType(ids);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            54, // uniffi_logins_fn_method_loginstore_delete_many
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterSequenceString.lower(ids),
        )
        return handleRustResult(
    ...
    async deleteUndecryptableRecordsForRemoteReplacement() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            55, // uniffi_logins_fn_method_loginstore_delete_undecryptable_records_for_remote_replacement
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async findLoginToUpdate(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            56, // uniffi_logins_fn_method_loginstore_find_login_to_update
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async get(
        ...
        FfiConverterString.checkType(id);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            57, // uniffi_logins_fn_method_loginstore_get
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    async getByBaseDomain(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            58, // uniffi_logins_fn_method_loginstore_get_by_base_domain
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async getCheckpoint() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            59, // uniffi_logins_fn_method_loginstore_get_checkpoint
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async hasLoginsByBaseDomain(
        ...
        FfiConverterString.checkType(baseDomain);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            60, // uniffi_logins_fn_method_loginstore_has_logins_by_base_domain
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(baseDomain),
        )
        return handleRustResult(
    ...
    async isEmpty() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            61, // uniffi_logins_fn_method_loginstore_is_empty
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async isPotentiallyVulnerablePassword(
        ...
        FfiConverterString.checkType(id);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            62, // uniffi_logins_fn_method_loginstore_is_potentially_vulnerable_password
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    async list() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            63, // uniffi_logins_fn_method_loginstore_list
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async recordBreachAlertDismissal(
        ...
        FfiConverterString.checkType(id);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            64, // uniffi_logins_fn_method_loginstore_record_breach_alert_dismissal
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    async recordBreachAlertDismissalTime(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            65, // uniffi_logins_fn_method_loginstore_record_breach_alert_dismissal_time
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
    ...
    async recordPotentiallyVulnerablePasswords(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            66, // uniffi_logins_fn_method_loginstore_record_potentially_vulnerable_passwords
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async registerWithSyncManager() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            67, // uniffi_logins_fn_method_loginstore_register_with_sync_manager
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async reset() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            68, // uniffi_logins_fn_method_loginstore_reset
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async resetAllBreaches() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            69, // uniffi_logins_fn_method_loginstore_reset_all_breaches
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async runMaintenance() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            70, // uniffi_logins_fn_method_loginstore_run_maintenance
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async setCheckpoint(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            71, // uniffi_logins_fn_method_loginstore_set_checkpoint
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    shutdown() {
        ...
        const result = UniFFIScaffolding.callSync(
            72, // uniffi_logins_fn_method_loginstore_shutdown
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async touch(
        ...
        FfiConverterString.checkType(id);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            73, // uniffi_logins_fn_method_loginstore_touch
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    async update(
        ...
        FfiConverterTypeLoginEntry.checkType(login);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            74, // uniffi_logins_fn_method_loginstore_update
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
            FfiConverterTypeLoginEntry.lower(login),
        )
    ...
    async wipeLocal() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            75, // uniffi_logins_fn_method_loginstore_wipe_local
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class ManagedEncryptorDecryptor extends ManagedEncryptorDecryptorInterface {
    ...
    static init(
        ...
        FfiConverterTypeKeyManager.checkType(keyManager);
        const result = UniFFIScaffolding.callSync(
            76, // uniffi_logins_fn_constructor_managedencryptordecryptor_new
            FfiConverterTypeKeyManager.lower(keyManager),
        )
        return handleRustResult(
            result,
...
export class NssKeyManager extends NssKeyManagerInterface {
    ...
    static init(
        ...
        FfiConverterTypePrimaryPasswordAuthenticator.checkType(primaryPasswordAuthenticator);
        const result = UniFFIScaffolding.callSync(
            77, // uniffi_logins_fn_constructor_nsskeymanager_new
            FfiConverterTypePrimaryPasswordAuthenticator.lower(primaryPasswordAuthenticator),
        )
        return handleRustResult(
            result,
    ...
    intoDynKeyManager() {
        ...
        const result = UniFFIScaffolding.callSync(
            78, // uniffi_logins_fn_method_nsskeymanager_into_dyn_key_manager
...
export class PrimaryPasswordAuthenticatorImpl extends PrimaryPasswordAuthenticator {
    ...
    async getPrimaryPassword() {
        ...
        const result = await UniFFIScaffolding.callAsync(
            79, // uniffi_logins_fn_method_primarypasswordauthenticator_get_primary_password
    ...
    async onAuthenticationSuccess() {
        ...
        const result = await UniFFIScaffolding.callAsync(
            80, // uniffi_logins_fn_method_primarypasswordauthenticator_on_authentication_success
            FfiConverterTypePrimaryPasswordAuthenticator.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async onAuthenticationFailure() {
        ...
        const result = await UniFFIScaffolding.callAsync(
            81, // uniffi_logins_fn_method_primarypasswordauthenticator_on_authentication_failure
            FfiConverterTypePrimaryPasswordAuthenticator.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class StaticKeyManager extends StaticKeyManagerInterface {
    ...
    static init(
        ...
        FfiConverterString.checkType(key);
        const result = UniFFIScaffolding.callSync(
            82, // uniffi_logins_fn_constructor_statickeymanager_new
            FfiConverterString.lower(key),
        )
        return handleRustResult(
            result,
