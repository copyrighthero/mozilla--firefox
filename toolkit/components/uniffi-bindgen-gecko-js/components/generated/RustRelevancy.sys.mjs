...
const result = UniFFIScaffolding.callSync(
    83, // uniffi_relevancy_fn_func_score
...
export class RelevancyStore extends RelevancyStoreInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            84, // uniffi_relevancy_fn_constructor_relevancystore_new
    ...
    async banditInit(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            85, // uniffi_relevancy_fn_method_relevancystore_bandit_init
    ...
    async banditSelect(
        ...
        FfiConverterSequenceString.checkType(arms);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            86, // uniffi_relevancy_fn_method_relevancystore_bandit_select
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
            FfiConverterString.lower(bandit),
            FfiConverterSequenceString.lower(arms),
        )
    ...
    async banditUpdate(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            87, // uniffi_relevancy_fn_method_relevancystore_bandit_update
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
            FfiConverterString.lower(bandit),
    ...
    close() {
        ...
        const result = UniFFIScaffolding.callSync(
            88, // uniffi_relevancy_fn_method_relevancystore_close
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async ensureInterestDataPopulated() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            89, // uniffi_relevancy_fn_method_relevancystore_ensure_interest_data_populated
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async getBanditData(
        ...
        FfiConverterString.checkType(arm);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            90, // uniffi_relevancy_fn_method_relevancystore_get_bandit_data
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
            FfiConverterString.lower(bandit),
            FfiConverterString.lower(arm),
        )
    ...
    async ingest(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            91, // uniffi_relevancy_fn_method_relevancystore_ingest
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
    ...
    interrupt() {
        ...
        const result = UniFFIScaffolding.callSync(
            92, // uniffi_relevancy_fn_method_relevancystore_interrupt
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async userInterestVector() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            93, // uniffi_relevancy_fn_method_relevancystore_user_interest_vector
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
