...
const result = UniFFIScaffolding.callSync(
    288, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_custom_type
...
const result = UniFFIScaffolding.callSync(
    289, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_enum
...
const result = UniFFIScaffolding.callSync(
    290, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_interface
...
const result = UniFFIScaffolding.callSync(
    291, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_record
